...
class CampaignsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_campaign_create_clone_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'Klaviyo-API-Key'
                ],
                'endpoint_path': '/api/campaign-create-clones/',
                'operation_id': 'create_campaign_create_clone',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.create_campaign_message_assign_template_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/campaign-message-assign-templates/',
            ...
            root_map={
                ...
                'allowed_values': {
                    ('fields_campaign',): {
                        ...
                        "SEND_OPTIONS.IGNORE_UNSUBSCRIBES": "send_options.ignore_unsubscribes",
                        "MESSAGE": "message",
    ...
    def create_campaign_create_clone(
        self,
        campaign_clone_query,
        **kwargs
    ):
        """Create Campaign Create Clone  # noqa: E501
        ...
        >>> thread = api.create_campaign_create_clone(campaign_clone_query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['campaign_clone_query'] = \
            campaign_clone_query
        return self.create_campaign_create_clone_endpoint.call_with_http_info(**kwargs)
    ...
    def get_campaign(
        ...
        **kwargs
        ...
        Keyword Args:
            fields_campaign ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets. [optional]
    ...
    def get_campaign_message(
        ...
        **kwargs
        ...
        Keyword Args:
            fields_campaign_message ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def get_campaign_send_job(
        ...
        **kwargs
        ...
        Keyword Args:
            fields_campaign_send_job ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def get_campaigns(
        ...
        **kwargs
        ...
        Keyword Args:
            fields_campaign ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets. [optional]
            fields_tag ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets. [optional]
            filter (str): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#filtering<br>Allowed field(s)/operator(s):<br>`name`: `contains`<br>`status`: `any`, `equals`<br>`archived`: `equals`<br>`created_at`: `greater-or-equal`, `greater-than`, `less-or-equal`, `less-than`<br>`scheduled_at`: `greater-or-equal`, `greater-than`, `less-or-equal`, `less-than`<br>`updated_at`: `greater-or-equal`, `greater-than`, `less-or-equal`, `less-than`. [optional]
            include ([str]): For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#relationships. [optional]
