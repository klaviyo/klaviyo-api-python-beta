...
def lazy_import():
    ...
    globals()['V2TemplateRenderQueryAsSubResource'] = V2TemplateRenderQueryAsSubResource


class V2TemplateRenderQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (V2TemplateRenderQueryAsSubResource,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """V2TemplateRenderQuery - a model defined in OpenAPI
