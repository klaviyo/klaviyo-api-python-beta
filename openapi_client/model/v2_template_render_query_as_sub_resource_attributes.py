...
class V2TemplateRenderQueryAsSubResourceAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, id, context, *args, **kwargs):  # noqa: E501
        """V2TemplateRenderQueryAsSubResourceAttributes - a model defined in OpenAPI

        Args:
            id (str): The ID of MessageTemplate
            context ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The context for the template render
