...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CatalogsApi()
        api_instance.create_catalog_category  # this is an instance of the class Endpoint
        api_instance.create_catalog_category()  # this invokes api_instance.create_catalog_category.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_catalog_category.callable or self.callable in this class
    ...
    def call_with_http_info(self, **kwargs):
        ...
        if 'api_key' in kwargs:
            ...
            kwargs['_request_auths'] = [{
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
                'value': f'Klaviyo-API-Key {api_key}'
                }]
